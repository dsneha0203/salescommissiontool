...
<tiles:insertDefinition name="defaultTemplate">
 ...
 <div class="container-fluid">
  ...
  <c:url var="addAction" value="/submitRole" ></c:url>
 
<form:form action="${addAction}" commandName="role">
      <table>  
       <tr>  
           <td><form:label path="id">Role ID:</form:label></td>  
           <td><form:input path="id" value="${role.id}" readonly="true" /></td>  
       </tr>  
       <tr>  
       ...
       <tr>  
           <td><form:label path="reportTo">Report To:</form:label></td>  
           <td><form:input path="reportTo" value="${role.reportTo}"/></td>  
       </tr>  
         
          <tr>  
        <td><input type="submit" value="Submit"/>
			| <a href="<c:url value='/roleList' />">Cancel</a></td>
        </tr>  
   </table>   
  </form:form>  
<br>
